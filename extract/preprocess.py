...
# 강수량
rn_raw = open('/mnt/user-data/uploads/rn_20260601171702.csv', encoding='cp949').read()
...
# 기온
ta_raw = open('/mnt/user-data/uploads/ta_20260601172048.csv', encoding='cp949').read()
...
df_final.to_csv('/mnt/user-data/outputs/haenam_merged.csv', index=False, encoding='utf-8-sig')
print("\n저장완료: haenam_merged.csv")
